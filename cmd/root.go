...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&flagBase, "base", "", "Content source: auto | flixhq.to | flixhq.ws | kimcartoon.com.co | soap2day | moviebox | vaplayer | vidnest | tbcpl | 1shows.org | allanime | yts")
